...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactTHREEMonkeyPatch = __webpack_require__(2);

	var _ReactTHREEMonkeyPatch2 = _interopRequireDefault(_ReactTHREEMonkeyPatch);

	var _THREERenderer = __webpack_require__(35);
	...
	(0, _ReactTHREEMonkeyPatch2.default)();

	// monkey patch to workaround some assumptions that we're working with the DOM


	module.exports = {
	  Renderer: _THREERenderer2.default,
	  Scene: _THREEScene2.default,
	  PerspectiveCamera: _THREEPerspectiveCamera2.default,
	  OrthographicCamera: _THREEOrthographicCamera2.default,
	  AxisHelper: _THREEAxisHelper2.default,
	  Line: _THREELine2.default,
	  LineSegments: _THREELineSegments2.default,
	  PointCloud: _THREEPointCloud2.default,
	  Object3D: _THREEObject3D2.default,
	  Mesh: _THREEMesh2.default,
	  SkinnedMesh: _THREESkinnedMesh2.default,
	  Sprite: _THREESprite2.default,
	  AmbientLight: _THREEAmbientLight2.default,
	  PointLight: _THREEPointLight2.default,
	  AreaLight: _THREEAreaLight2.default,
	  DirectionalLight: _THREEDirectionalLight2.default,
	  HemisphereLight: _THREEHemisphereLight2.default,
	  SpotLight: _THREESpotLight2.default,
	  Helper: _THREEDecoratorHelper2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactCompositeComponent = __webpack_require__(29);

	var _ReactCompositeComponent2 = _interopRequireDefault(_ReactCompositeComponent);

	var _ReactReconciler = __webpack_require__(30);

	var _ReactReconciler2 = _interopRequireDefault(_ReactReconciler);

	var _shouldUpdateReactComponent = __webpack_require__(31);
	...
	var ReactTHREE_updateRenderedComponent = function ReactTHREE_updateRenderedComponent(transaction, context) {
	  ...
	  if ((0, _shouldUpdateReactComponent2.default)(prevRenderedElement, nextRenderedElement)) {
	    ...
	    var nextObject3D = _ReactReconciler2.default.mountComponent(this._renderedComponent, thisID, transaction, this._processChildContext(context));
	...
	var ReactTHREEMonkeyPatch = function ReactTHREEMonkeyPatch() {
	  ...
	  if (typeof old_ReactReconciler_receiveComponent._ReactTHREEPatched === 'undefined') {
	    (0, _warning2.default)(false, "patching react to work with react-three");

	    _ReactReconciler2.default.receiveComponent = buildPatchedReceiveComponent(old_ReactReconciler_receiveComponent);
	    _ReactReconciler2.default.receiveComponent._ReactTHREEPatched = true;
	  }
	};

	exports.default = ReactTHREEMonkeyPatch;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREERenderer = _react2.default.createClass({
	  displayName: 'THREERenderer',
	  mixins: [_THREEContainerMixin2.default],

	  propTypes: {
	    enableRapidRender: _react2.default.PropTypes.bool,
	    pixelRatio: _react2.default.PropTypes.number,
	    pointerEvents: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.string),
	    transparent: _react2.default.PropTypes.bool,
	    disableHotLoader: _react2.default.PropTypes.bool,
	    customRender: _react2.default.PropTypes.func,
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    var renderelement = this.props.canvas || _reactDom2.default.findDOMNode(this);
	    ...
	    var backgroundtype = (0, _typeof3.default)(props.background);
	    if (backgroundtype !== 'undefined') {
	      // background color should be a number, check it
	      (0, _warning2.default)(backgroundtype === 'number', "The background property of " + "the Renderer component must be a number, not " + backgroundtype);
	    ...
	    if (this.props.enableRapidRender) {
	      (function () {
	        var rapidrender = function rapidrender(timestamp) {
	          ...
	          if (typeof _this._rAFID !== 'undefined') {
	    ...
	    (0, _warning2.default)(typeof props.listenToClick === 'undefined', "the `listenToClick` prop has been replaced with `pointerEvents`");
	  ...
	  componentDidUpdate: function componentDidUpdate(oldProps) {
	    ...
	    if (props.width !== oldProps.width || props.height !== oldProps.height || props.pixelRatio !== oldProps.pixelRatio) {
	      this._THREErenderer.setSize(+props.width, +props.height);
	    }
	    ...
	    if (backgroundtype !== 'undefined') {
	      // background color should be a number, check it
	      (0, _warning2.default)(backgroundtype === 'number', "The background property of " + "the scene component must be a number, not " + backgroundtype);
	      this._THREErenderer.setClearColor(props.background, this.props.transparent ? 0 : 1);
	    }
	  ...
	  componentWillUnmount: function componentWillUnmount() {
	    ...
	    _EventPluginHub2.default.deleteAllListeners(this._reactInternalInstance);
	  ...
	  renderScene: function renderScene() {
	    ...
	    (0, _keys2.default)(children).forEach(function (key) {
	      ...
	      if (scene._THREEObject3D && scene._THREEMetaData.camera !== null) {
	        if (_this2._customRender) {
	          _this2._customRender(_this2._THREErenderer, scene._THREEObject3D, scene._THREEMetaData.camera);
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(19)(IteratorPrototype, __webpack_require__(63)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEContainerMixin = (0, _objectAssign2.default)({}, _ReactMultiChild2.default.Mixin, {
	  moveChild: function moveChild(prevChild, lastPlacedNode, nextIndex, lastIndex) {
	    // eslint-disable-line no-unused-vars
	    // no-op for the renderer
	    if (typeof this.renderScene !== 'undefined') {
	      return;
	    }
	    ...
	    var THREEObject3D = this._mountImage || this._THREEObject3D;
	  ...
	  createChild: function createChild(child, afterNode, childTHREEObject3D) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ELEMENT_TYPE_NODE = 1; // can't access this in ReactDOMComponent

	//
	// The 'Scene' component includes the three.js scene
	//

	var THREEScene = (0, _Utils.createTHREEComponent)('THREEScene', _THREEObject3DMixin2.default, {
	  createTHREEObject: function createTHREEObject() {
	    return new _three2.default.Scene();
	  },

	  applySpecificTHREEProps: function applySpecificTHREEProps(oldProps, newProps) {// eslint-disable-line no-unused-vars
	  ...
	  mountComponent: function mountComponent(transaction, nativeParent, nativeContainerInfo, context) {
	    ...
	    _THREEObject3DMixin2.default.mountComponent.call(this, transaction, nativeParent, nativeContainerInfo, context);
	    this._THREEMetaData = {
	      camera: null,
	  ...
	  receiveComponent: function receiveComponent(nextElement, transaction, context) {
	    _THREEObject3DMixin2.default.receiveComponent.call(this, nextElement, transaction, context);
	  },

	  unmountComponent: function unmountComponent() {
	    _THREEObject3DMixin2.default.unmountComponent.call(this);
	  },
	  ...
	  bindCamera: function bindCamera(props) {
	    ...
	    if (typeof camera === 'string') {
	      ...
	      (0, _warning2.default)(false, "No camera prop specified for react-three scene, using 'maincamera'");
	      ...
	      if (typeof camera === 'undefined') {
	        (0, _warning2.default)(false, "No camera named 'maincamera' found, creating a default camera");
	        camera = new _three2.default.PerspectiveCamera(75, props.width / props.height, 1, 5000);
	  ...
	  bindOrbitControls: function bindOrbitControls(inst, canvas, props) {
	  ...
	  bindPointerEvents: function bindPointerEvents(inst, canvas, props) {
	    var _this = this;

	    if (props.pointerEvents) {
	      if (canvas) {
	        props.pointerEvents.forEach(function (eventName) {
	          (0, _ReactBrowserEventEmitter.listenTo)(eventName, canvas);
	          _EventPluginHub2.default.putListener(inst, eventName, function (event) {
	  ...
	  findRootDOMNode: function findRootDOMNode(rootID) {
	    ...
	    var container = _ReactMount2.default.findReactContainerForID(rootID);
	    return container;
	  },
	  ...
	  projectPointerEvent: function projectPointerEvent(event, eventName, canvas) {
	    ...
	    var _THREEMetaData = this._THREEMetaData,
	        raycaster = _THREEMetaData.raycaster,
	        camera = _THREEMetaData.camera;
...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	var THREEObject3DMixin = (0, _objectAssign2.default)({}, _THREEContainerMixin2.default, {
	  ...
	  applyTHREEObject3DPropsToObject: function applyTHREEObject3DPropsToObject(THREEObject3D, oldProps, props) {
	    ...
	    if (typeof props.matrix !== 'undefined') {
	      ...
	      (0, _warning2.default)(typeof props.position === 'undefined', "The `position` property " + "of 3D objects is ignored when the `matrix` property is specified");
	      (0, _warning2.default)(typeof props.rotation === 'undefined', "The `rotation` property " + "of 3D objects is ignored when the `matrix` property is specified");
	      (0, _warning2.default)(typeof props.quaternion === 'undefined', "The `quaternion` property " + "of 3D objects is ignored when the `matrix` property is specified");
	      (0, _warning2.default)(typeof props.scale === 'undefined', "The `scale` property " + "of 3D objects is ignored when the `matrix` property is specified");
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createTHREEComponent(name) {
	  var ReactTHREEComponent = function ReactTHREEComponent(element) {
	    this.node = null;
	  ...
	  try {
	    for (var _iterator = (0, _getIterator3.default)(mixins), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      (0, _objectAssign2.default)(ReactTHREEComponent.prototype, m);
	    }
	  } catch (err) {
	...
	function setNewLightColor(targetColor, sourceValue) {
	  ...
	  } else if ((typeof sourceValue === 'undefined' ? 'undefined' : (0, _typeof3.default)(sourceValue)) === 'object' && sourceValue !== null && sourceValue instanceof _three2.default.Color) {
	    targetColor.copy(sourceValue);
	  } else {
	    (0, _warning2.default)(false, "Light color must be a number or an instance of THREE.Color");
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEPerspectiveCamera = (0, _Utils.createTHREEComponent)('PerspectiveCamera', _THREEObject3DMixin2.default, {
	  createTHREEObject: function createTHREEObject() {
	    return new _three2.default.PerspectiveCamera();
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEOrthographicCamera = (0, _Utils.createTHREEComponent)('OrthographicCamera', _THREEObject3DMixin2.default, {
	  createTHREEObject: function createTHREEObject() {
	    return new _three2.default.OrthographicCamera();
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _Utils.createTHREEComponent)('AxisHelper', _THREEObject3DMixin2.default, {
	    createTHREEObject: function createTHREEObject() {
	        return new _three2.default.AxisHelper(this._currentElement.props.size || 5);
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREELine = (0, _Utils.createTHREEComponent)('Line', _THREEObject3DMixin2.default, {
	    createTHREEObject: function createTHREEObject() {
	        return new _three2.default.Line();
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREELineSegments = (0, _Utils.createTHREEComponent)('LineSegments', _THREEObject3DMixin2.default, {
	    createTHREEObject: function createTHREEObject() {
	        return new _three2.default.LineSegments();
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEPointCloud = (0, _Utils.createTHREEComponent)('PointCloud', _THREEObject3DMixin2.default, {
	    createTHREEObject: function createTHREEObject() {
	        return new _three2.default.PointCloud(new _three2.default.Geometry());
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEObject3D = (0, _Utils.createTHREEComponent)('Object3D', _THREEObject3DMixin2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEMesh = (0, _Utils.createTHREEComponent)('Mesh', _THREEObject3DMixin2.default, {
	    createTHREEObject: function createTHREEObject() {
	        return new _three2.default.Mesh(new _three2.default.Geometry(), new _three2.default.Material()); // starts out empty
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREESkinnedMesh = (0, _Utils.createTHREEComponent)('SkinnedMesh', _THREEObject3DMixin2.default, {
	    // skinned mesh is special since it needs the geometry and material data upon construction
	    /* jshint unused: vars */
	    mountComponent: function mountComponent(rootID, transaction, context) {
	        this._THREEObject3D = new _three2.default.SkinnedMesh(this._currentElement.props.geometry, this._currentElement.props.material);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREESprite = (0, _Utils.createTHREEComponent)('Sprite', _THREEObject3DMixin2.default, {
	    createTHREEObject: function createTHREEObject() {
	        return new _three2.default.Sprite();
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEAmbientLight = (0, _Utils.createTHREEComponent)('AmbientLight', _THREEObject3DMixin2.default, {
	  createTHREEObject: function createTHREEObject() {
	    return new _three2.default.AmbientLight(0x000000);
	  },

	  applySpecificTHREEProps: function applySpecificTHREEProps(oldProps, newProps) {
	    _LightObjectMixin2.default.applySpecificTHREEProps.call(this, oldProps, newProps);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEPointLight = (0, _Utils.createTHREEComponent)('PointLight', _THREEObject3DMixin2.default, {
	  createTHREEObject: function createTHREEObject() {
	    return new _three2.default.PointLight(0xffffff, 1, 100);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEAreaLight = (0, _Utils.createTHREEComponent)('AreaLight', _THREEObject3DMixin2.default, {
	  createTHREEObject: function createTHREEObject() {
	    return new _three2.default.AreaLight(0xffffff, 1);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEDirectionalLight = (0, _Utils.createTHREEComponent)('DirectionalLight', _THREEObject3DMixin2.default, {
	  createTHREEObject: function createTHREEObject() {
	    return new _three2.default.DirectionalLight(0xffffff, 1);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THREEHemisphereLight = (0, _Utils.createTHREEComponent)('HemisphereLight', _THREEObject3DMixin2.default, {
	  createTHREEObject: function createTHREEObject() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _Utils.createTHREEComponent)('THREEDecoratorHelper', _THREEObject3DMixin2.default, {
	  createTHREEObject: function createTHREEObject() {
	    return new _three2.default.Object3D();
	  },
	  applySpecificTHREEProps: function applySpecificTHREEProps() /*oldProps, newProps*/{
	  ...
	  applyHelpers: function applyHelpers(newHelperTypes) {
	    // an array of helper instances
	    var currentHelpers = this._THREEMetaData;
	    ...
	    var helperContainerNode = this._THREEObject3D;
	    var helperWrapNode = helperContainerNode.children[0];

	    // figure out which helpers to add and remove
	    var helperAddTypeList = _lodash2.default.differenceWith(newHelperTypes, currentHelpers, function (a, b) {
	      return b instanceof a;
	    });
	    var helperRemoveList = _lodash2.default.differenceWith(currentHelpers, newHelperTypes, function (a, b) {
	    ...
	    try {
	      for (var _iterator = (0, _getIterator3.default)(helperAddTypeList), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var newHelperType = _step.value;

	        var newHelper = new newHelperType(helperWrapNode);
	    ...
	    try {
	      for (var _iterator2 = (0, _getIterator3.default)(helperRemoveList), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	        var removeHelper = _step2.value;

	        _lodash2.default.remove(currentHelpers, removeHelper);
	        _lodash2.default.remove(helperContainerNode.children, removeHelper);
	      }
	    } catch (err) {
	  ...
	  mountComponent: function mountComponent(rootID, transaction, context) {
	    var props = this._currentElement.props;
	    _THREEObject3DMixin2.default.mountComponent.call(this, rootID, transaction, context);
	  ...
	  receiveComponent: function receiveComponent(nextElement, transaction, context) {
	    ...
	    try {
	      for (var _iterator3 = (0, _getIterator3.default)(currentHelpers), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    X_AXIS: new _three2.default.Vector3(1, 0, 0),
	    Y_AXIS: new _three2.default.Vector3(0, 1, 0),
	    Z_AXIS: new _three2.default.Vector3(0, 0, 1)
